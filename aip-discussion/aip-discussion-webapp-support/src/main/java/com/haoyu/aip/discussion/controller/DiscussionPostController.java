...
@Controller
@RequestMapping("**/discussion/post")
public class DiscussionPostController extends AbstractBaseController{
	...
	public String list(SearchParam searchParam, Model model){
		...
		return "discussion/list_discussion_post";
	}
	...
	public String listChild(SearchParam searchParam, Model model){
		...
		model.addAllAttributes(request.getParameterMap());
		return "discussion/list_child_discussion_post";
	}
}
